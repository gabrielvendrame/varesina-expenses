...
function MobileNavbar() {
    ...
    return (
        <div className="block border-separete bg-background md:hidden">
            <nav className="container flex items-center justify-between pe-2">
...
function NavbarItem({label, link, clickCallback}: { label: string, link: string, clickCallback?: () => void }) {
    ...
    return (
        <div className="relative flex items-center">
            ...
            {isActive && (<div
                className="absolute -bottom-[2px] left-1/2 hidden h-[2px] w-[80%] -translate-x-1/2 rounded-xl md:block bg-white"></div>)}
        </div>
    )
}
